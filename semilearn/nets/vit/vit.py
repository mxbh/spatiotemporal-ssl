...
#---------------------------------------------------------------
# vit-s and vit-b for 128 imgs; for vit-t and vit-l, look for checkpoints externally
def vit_small_patch16_128(pretrained=False, pretrained_path=None, **kwargs):
    """ViT-Small (ViT-S/16)"""
    model_kwargs = dict(
        img_size=128,
        patch_size=16,
...
def vit_base_patch16_128(pretrained=False, pretrained_path=None, **kwargs):
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.  # noqa: E501
    """
    model_kwargs = dict(
