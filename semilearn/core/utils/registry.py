...
ALL_MODULES = [
    ...
    ('semilearn.algorithms', ['adamatch', 'cap', 'comatch', 'crmatch', 'dash', 'fixmatch', 'flexmatch', 'fullysupervised', 'meanteacher',
                              'mixmatch', 'pimodel', 'pseudolabel', 'remixmatch', 'simmatch', 'uda', 'udal', 'vat', 'softmatch', 'freematch', 'defixmatch', 'cdmad']),
